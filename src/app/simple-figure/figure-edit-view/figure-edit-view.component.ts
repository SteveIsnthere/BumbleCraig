...
export class FigureEditViewComponent extends SimpleFigureComponent {
    ...
    constructor(http: HttpClient, @Inject(MAT_BOTTOM_SHEET_DATA) figureID: number, private bottomSheet: MatBottomSheet, el: ElementRef, cache: SimpleFigureCachingService) {
        super(http, el, cache);
